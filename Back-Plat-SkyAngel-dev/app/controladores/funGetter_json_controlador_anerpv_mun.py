import json
import pandas as pd
from app.mapper.getter_json_mapper_anerpv_mun import jsonAcumAnerpvMun

class GetJsonMunicipioServiceAnerpv():

    def __init__(self):
        self.jsonAcumAnerpvMun = jsonAcumAnerpvMun()
        

    def obtenerDatos(self, jsonParametros):
        # 1. Obtener los datos usando el mapper
        datos_mapper_result = self.jsonAcumAnerpvMun.selectIncidentes(jsonParametros)
        ...
        for id_entidad, group in df.groupby('cve_municipio'):
