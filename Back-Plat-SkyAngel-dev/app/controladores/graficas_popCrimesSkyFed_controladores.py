import json
import pandas as pd
from app.mapper.graficas_popCrimesSkyFed_mapper import skyaAngelBarrasMapper
...
class skyBarrasAcumService():
    
    def __init__(self):
        self.skyaAngelBarrasMapperAcum = skyaAngelBarrasMapper()
    ...
    def obtenerDatos(self, jsonParametros):
        ...
        try:
            ...
            responseData = self.skyaAngelBarrasMapperAcum.selectIncidentes(mapper_params)
