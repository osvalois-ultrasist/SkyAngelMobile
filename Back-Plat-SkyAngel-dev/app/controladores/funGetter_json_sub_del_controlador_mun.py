import json
import pandas as pd
from app.mapper.getter_json_sub_del_mapper_mun import SubtipoDelitosTotalMun
...
class GetJsonSubtipoMunService():

    def __init__(self):
        self.subtipo_delitos_mapper = SubtipoDelitosTotalMun()
