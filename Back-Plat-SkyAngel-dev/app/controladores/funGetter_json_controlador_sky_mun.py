import json
import pandas as pd
from app.mapper.getter_json_mapper_sky_mun import jsonAcumSkyMun

class GetJsonMunicipioServiceSky():

    def __init__(self):
        self.jsonAcumSkyMun = jsonAcumSkyMun()
        

    def obtenerDatos(self, jsonParametros):
        # 1. Obtener los datos usando el mapper
        datos_mapper_result = self.jsonAcumSkyMun.selectIncidentes(jsonParametros)
