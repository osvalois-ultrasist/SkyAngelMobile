import json
import pandas as pd
from app.mapper.getter_json_mapper_sky import jsonAcumSky

class GetJsonSubtipoEntidadServiceSky():

    def __init__(self):
        self.jsonAcumSky = jsonAcumSky()
        

    def obtenerDatos(self, jsonParametros):
        # 1. Obtener los datos usando el mapper
        datos_mapper_result = self.jsonAcumSky.selectIncidentes(jsonParametros)
