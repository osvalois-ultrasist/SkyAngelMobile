import json
import pandas as pd
from app.mapper.graficas_popCrimesSkyEst_controladores import skyBarrasEntidadMapper
...
class skyBarrasMunSelService():
    ...
    def __init__(self):
        self.skyEntidadMapper = skyBarrasEntidadMapper()
    ...
    def obtenerDatos(self, jsonParametros):
        ...
        try:
            ...
            responseData = self.skyEntidadMapper.selectIncidentes(mapper_params)
