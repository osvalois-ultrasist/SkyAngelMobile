...
from app.mapper.getter_json_all_fuentes_entidad_mapper import getterJsonMapperAllEntidad


class getterJsonAllEntidad():

    def __init__(self):
        self.getterJsonMapperAll = getterJsonMapperAllEntidad()
