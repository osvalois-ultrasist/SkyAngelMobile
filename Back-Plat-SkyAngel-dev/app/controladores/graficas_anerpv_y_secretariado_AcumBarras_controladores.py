...
from app.mapper.graficas_popCrimesAllFed_mapper import barrasAcumMapperAnerpvSecretariado


class barrasAcumServiceAnerpvSecretariado():

    def __init__(self):
        self.secretariadoBarrasAcum = barrasAcumMapperAnerpvSecretariado()
    ...
    def obtenerDatos(self, jsonParametros):
        ...
        try:
            ...
            responseData = self.secretariadoBarrasAcum.selectIncidentesCombinados(mapper_params)
            ...
            organizedData = {
                "title": "Robo a transporte por año (Secretariado vs Anerpv)",
                "series": [
                    {"label": "Secretariado", "data": crimenesSecretariado},
                    {"label": "Anerpv", "data": crimenesAnerpv},
