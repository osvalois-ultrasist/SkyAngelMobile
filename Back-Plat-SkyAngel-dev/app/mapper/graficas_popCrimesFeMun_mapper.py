    ...
    def selectIncidentes(self, jsonParametros):
        try:
            ...
            with get_cursor() as cursor:
                ...
                FROM 
                    sum_delitos_municipio_mes_anerpv_vista anerpv
                JOIN cat_meses cm
                ...
                if entidades and 0 not in entidades:
                    condiciones.append("anerpv.cve_municipio IN %s")
                ...
                query += """  
                    GROUP BY anerpv.anio, anerpv.cve_municipio,anerpv.id_mes, cm.mes
