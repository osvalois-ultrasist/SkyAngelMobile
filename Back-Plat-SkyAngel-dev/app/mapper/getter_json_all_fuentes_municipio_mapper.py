...
class getterJsonMapperAllMunicipio():
        ...
        try:
            ...
            with get_cursor() as cursor:
                ...
                SELECT
                    anio,
                    id_municipio,
                    SUM(conteo_secretariado) AS total_secretariado,
                    SUM(conteo_anerpv) AS total_anerpv,
                    SUM(conteo_sky) as total_sky
                FROM (
                    SELECT
                        anio,
                        id_municipio,
                ...
                if municipios and 0 not in municipios:
                    ...
                    params_sec.append(tuple(municipios))
                ...
                if municipios and 0 not in municipios:
                    ...
                    params_anerpv.append(tuple(municipios))
                ...
                if municipios and 0 not in municipios:
                    ...
                    params_sky.append(tuple(municipios))
