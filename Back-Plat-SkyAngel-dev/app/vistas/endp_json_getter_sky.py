...
from app.controladores.funGetter_json_controlador_sky import GetJsonSubtipoEntidadServiceSky
...
getterJsonSky_bp = Blueprint('popular-crimes-getter-json-sky', __name__)
