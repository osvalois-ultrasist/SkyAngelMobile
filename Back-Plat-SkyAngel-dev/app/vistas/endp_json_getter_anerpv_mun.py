...
getterJsonAnerpvMun_bp = Blueprint('/popular-crimes/get-json-anerpv-mun', __name__)

@getterJsonAnerpvMun_bp.route("/popular-crimes/get-json-anerpv-mun", methods=["POST"])
def secBarrasMunicipio():
    if request.method == 'POST':
        try:
            ...
            data = GetJsonMunicipioServiceAnerpv().obtenerDatos(parametros)    
