...
getterJsonSky_bp = Blueprint('/popular-crimes/get-json-sky', __name__)

@getterJsonSky_bp.route("/popular-crimes/get-json-fed-fe", methods=["POST"])
def secBarrasMunicipio():
    if request.method == 'POST':
        try:
            ...
            data = GetJsonSubtipoEntidadServiceSky().obtenerDatos(parametros)    
