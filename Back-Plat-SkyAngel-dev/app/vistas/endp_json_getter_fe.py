...
from app.controladores.funGetter_json_controlador_anerpv_mun import GetJsonMunicipioServiceAnerpv
...
getterJsonFe_bp = Blueprint('popular-crimes-getter-json-fe', __name__)
