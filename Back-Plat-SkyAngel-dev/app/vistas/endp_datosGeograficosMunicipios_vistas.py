...
from app.configuraciones.rutas_archivos import BUCKET_NAME, KEY_DATOS_GEOGRAFICOS_MUN

# Se crea la coleccion de endpoints                           
municipiosDatosGeograficos = Blueprint('municipiosDatosGeograficos', __name__)
      
@municipiosDatosGeograficos.route("/municipios/datos-geograficos", methods=["GET"])
def municipiosDatosGeograficos_get():
    try:
        ...
        s3_response = s3.get_object(Bucket=BUCKET_NAME, Key=KEY_DATOS_GEOGRAFICOS_MUN)
