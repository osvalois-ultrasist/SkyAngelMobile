...
from app.configuraciones.rutas_archivos import BUCKET_NAME, KEY_DATOS_GEOGRAFICOS_ENT

# Se crea la coleccion de endpoints                           
entidadDatosGeograficos = Blueprint('entidadDatosGeograficos', __name__)
      
@entidadDatosGeograficos.route("/entidad/datos-geograficos", methods=["GET"])
def entidadDatosGeograficos_get():
    try:
        ...
        s3_response = s3.get_object(Bucket=BUCKET_NAME, Key=KEY_DATOS_GEOGRAFICOS_ENT)
