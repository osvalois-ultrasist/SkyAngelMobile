          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ShadowTokens.createShadow(
                ...
                blurRadius: DesignTokens.blurRadiusXXL,
        ...
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            return Transform.scale(
              scale: _hoverAnimation.value * (widget.isSelected ? _bounceAnimation.value : 1.0),
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Stack(
                      ...
                      children: [
                        // Background pulse effect for selected item
                        if (widget.isSelected)
                          AnimatedBuilder(
...
class _AlertButtonState extends State<AlertButton>
  ...
  void initState() {
    ...
    _pulseController = AnimationController(
      duration: DesignTokens.animationDurationExtraSlow * 3,
      vsync: this,
    );
